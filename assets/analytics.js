...
(() => {
  ...
  style.rel = 'stylesheet'; style.href = '/assets/analytics.css?v=20260919-1';
  document.head.appendChild(style);
  const panel = document.createElement('section');
  panel.className = 'analytics-consent';
  panel.setAttribute('aria-label', 'Optional analytics');
  panel.hidden = true;
  panel.innerHTML = '<div><h2>Help improve this portfolio?</h2><p>With your permission, Google Analytics measures visits, time spent and clicks. The site works fully without it. <a href="/privacy/#analytics">Read about analytics</a>.</p></div><div class="analytics-actions"><button type="button" data-choice="denied">No thanks</button><button type="button" data-choice="granted">Allow analytics</button><button type="button" data-close hidden>Close</button></div>';
